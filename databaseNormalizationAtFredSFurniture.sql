...
CREATE TABLE items AS SELECT DISTINCT item_1_id AS item_id, item_1_name AS item_name, item_1_price AS price
FROM store
UNION
...
CREATE TABLE orders AS SELECT order_id, order_date, customer_id
FROM store;
